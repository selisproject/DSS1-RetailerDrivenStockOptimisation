...
(function (DSS1_RetailerDriverStockOptimisation) {
    ...
    (function (Controllers) {
        ...
        var SignOutPageController = /** @class */ (function () {
            function SignOutPageController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS1_RetailerDriverStockOptimisation.ViewModels.SignOutPage.SignOutPageViewModel._initializeFrom($scope.model, context);
                };
