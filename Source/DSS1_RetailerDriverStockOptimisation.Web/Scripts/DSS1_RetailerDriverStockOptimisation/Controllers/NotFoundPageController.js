...
(function (DSS1_RetailerDriverStockOptimisation) {
    ...
    (function (Controllers) {
        ...
        var NotFoundPageController = /** @class */ (function () {
            function NotFoundPageController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS1_RetailerDriverStockOptimisation.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom($scope.model, context);
                };
