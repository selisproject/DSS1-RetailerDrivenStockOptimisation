...
interface Window { scope_ManageRole: DSS1_RetailerDriverStockOptimisation.Controllers.IManageRoleScope; }
...
model:
    DSS1_RetailerDriverStockOptimisation.ViewModels.ManageRole.ManageRoleViewModel;
...
private timeoutDelayLockButton3Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS1_RetailerDriverStockOptimisation.ViewModels.ManageRole.ManageRoleViewModel._lightCast(window.scope_ManageRole.model);
    ...
    constructor(private $scope: IManageRoleScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS1_RetailerDriverStockOptimisation.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageRoleScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS1_RetailerDriverStockOptimisation.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom(window.viewDTO.Model);
            ...
            (e, DataItem, _parents) => {
                ...
                this.timeoutDelayLockAddPermissionOnChange = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        ...
                        if( eval(`DSS1_RetailerDriverStockOptimisation.ViewModels.ManageRole.FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel`) != null && eval(`DSS1_RetailerDriverStockOptimisation.ViewModels.ManageRole.FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel._initializeFrom`) != null ) {
                            ...
                            for(var _i = 0; _i < _initial.length; _i++) {
                                var _temp = eval(`DSS1_RetailerDriverStockOptimisation.ViewModels.ManageRole.FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel._initializeFrom(_initial[_i])`);
