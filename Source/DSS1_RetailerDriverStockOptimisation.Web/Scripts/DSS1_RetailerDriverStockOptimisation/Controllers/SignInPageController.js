...
(function (DSS1_RetailerDriverStockOptimisation) {
    ...
    (function (Controllers) {
        ...
        var SignInPageController = /** @class */ (function () {
            function SignInPageController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS1_RetailerDriverStockOptimisation.ViewModels.SignInPage.SignInPageViewModel._initializeFrom($scope.model, context);
                };
