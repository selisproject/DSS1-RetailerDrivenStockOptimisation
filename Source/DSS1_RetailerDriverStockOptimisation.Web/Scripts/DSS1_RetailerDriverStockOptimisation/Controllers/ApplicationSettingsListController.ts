...
interface Window { scope_ApplicationSettingsList: DSS1_RetailerDriverStockOptimisation.Controllers.IApplicationSettingsListScope; }
...
model:
    DSS1_RetailerDriverStockOptimisation.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel;
...
private timeoutDelayLockIcon3Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS1_RetailerDriverStockOptimisation.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._lightCast(window.scope_ApplicationSettingsList.model);
    ...
    constructor(private $scope: IApplicationSettingsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS1_RetailerDriverStockOptimisation.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IApplicationSettingsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS1_RetailerDriverStockOptimisation.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom(window.viewDTO.Model);
