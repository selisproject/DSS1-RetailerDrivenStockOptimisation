...
interface Window { scope_SignInPage: DSS1_RetailerDriverStockOptimisation.Controllers.ISignInPageScope; }
...
model:
    DSS1_RetailerDriverStockOptimisation.ViewModels.SignInPage.SignInPageViewModel;
...
private timeoutDelayLockButton2Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS1_RetailerDriverStockOptimisation.ViewModels.SignInPage.SignInPageViewModel._lightCast(window.scope_SignInPage.model);
    ...
    constructor(private $scope: ISignInPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS1_RetailerDriverStockOptimisation.ViewModels.SignInPage.SignInPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: ISignInPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS1_RetailerDriverStockOptimisation.ViewModels.SignInPage.SignInPageViewModel._initializeFrom(window.viewDTO.Model);
