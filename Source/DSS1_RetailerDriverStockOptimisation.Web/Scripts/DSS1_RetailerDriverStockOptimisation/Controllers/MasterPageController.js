    ...
    (function (Controllers) {
        ...
        var MasterPageConditionalFormattings = [
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () { return window._context.currentUsername; }, "")); }, false)];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnSubmit, Joove.EvaluationTimes.OnChange],
                isRelatedToDataValidation: false
        ...
        Controllers.AppNotifications_ColumnInfo = [new Joove.ColumnInfo("DateCreated", "DateTime", null, false),
            new Joove.ColumnInfo("Item", "string", null, false),
            new Joove.ColumnInfo("Delta", "int", null, false)];
        window["AppNotifications_ColumnInfo"] = Controllers.AppNotifications_ColumnInfo;
        ...
        var MasterPageController = /** @class */ (function () {
            function MasterPageController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPage.MasterPageViewModel._initializeFrom($scope.model, context);
                };
            ...
            MasterPageController.prototype.init = function ($scope, $timeout) {
                ...
                //}
                $.connection['eventsHub'].on('appNotificationCreated', function (guid, timestamp, inputs) {
                ...
                $scope.connectedToSignals = function () {
                    var AppNotificationCreatedGroups = (function () {
                        return null;
                    })();
                    if (AppNotificationCreatedGroups != null) {
                        for (var i = 0; i < AppNotificationCreatedGroups.length; i++) {
                ...
                // Event Listeners
                $scope.events = {
                    AppNotificationCreated: function () {
                        setTimeout(function () {
                            AppNotificationCreated_eventsQueue.sort(function (a, b) {
                                return (a.time > b.time) ? 1 : ((b.time > a.time) ? -1 : 0);
                            });
                            var implementation = function () {
                                Joove.Common.nullSafe(function () { return window._commander.gridRefresh(["NotificationTable"]); }, null);
                            };
                            implementation();
                ...
                $scope.actions = {
                    ...
                    NotificationRead: function (appNotification, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    Joove.Common.autocompleteFix();
                ...
                $scope.eventCallbacks = {
                    MainMenuHeaderMenuItemPressed: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockMainMenuHeaderMenuItemPressed = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("StockManagerView", "Render", "GET", [], null, null, openInNewWindow);
                    ...
                    KPIDashboardMenuItemPressed: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockKPIDashboardMenuItemPressed != null) {
                            $timeout.cancel(_this.timeoutDelayLockKPIDashboardMenuItemPressed);
                        }
                        _this.timeoutDelayLockKPIDashboardMenuItemPressed = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("KPIDashboard", "Render", "GET", [], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    MPAnalyticsMenuItemPressed: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockMPAnalyticsMenuItemPressed != null) {
                            $timeout.cancel(_this.timeoutDelayLockMPAnalyticsMenuItemPressed);
                        }
                        _this.timeoutDelayLockMPAnalyticsMenuItemPressed = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("Analytics", "Render", "GET", ["now-5d"], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    OrderForecastMenuItemPressed: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockOrderForecastMenuItemPressed != null) {
                            $timeout.cancel(_this.timeoutDelayLockOrderForecastMenuItemPressed);
                        }
                        _this.timeoutDelayLockOrderForecastMenuItemPressed = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("OrderForecast", "Retrieve", "GET", [], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    ...
                    MPAddContactMenuItemPressed: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockMPAddContactMenuItemPressed != null) {
                            $timeout.cancel(_this.timeoutDelayLockMPAddContactMenuItemPressed);
                        }
                        _this.timeoutDelayLockMPAddContactMenuItemPressed = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("NewContact", "NewUser", "GET", [], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    ...
                    MPCalculationsMenuItemPressed: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockMPCalculationsMenuItemPressed != null) {
                            $timeout.cancel(_this.timeoutDelayLockMPCalculationsMenuItemPressed);
                        }
                        _this.timeoutDelayLockMPCalculationsMenuItemPressed = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("CalculationsForm", "Render", "GET", [], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    ...
                    MPSupOrderForecastMenuItemPressed: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockMPSupOrderForecastMenuItemPressed != null) {
                            $timeout.cancel(_this.timeoutDelayLockMPSupOrderForecastMenuItemPressed);
                        }
                        _this.timeoutDelayLockMPSupOrderForecastMenuItemPressed = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("SupplierOrderForecast", "Retrieve", "GET", [], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    MPAgreementListMenuItemPressed: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockMPAgreementListMenuItemPressed != null) {
                            $timeout.cancel(_this.timeoutDelayLockMPAgreementListMenuItemPressed);
                        }
                        _this.timeoutDelayLockMPAgreementListMenuItemPressed = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                    ...
                    MPSupplierViewMenuItemPressed: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockMPSupplierViewMenuItemPressed != null) {
                            $timeout.cancel(_this.timeoutDelayLockMPSupplierViewMenuItemPressed);
                        }
                        _this.timeoutDelayLockMPSupplierViewMenuItemPressed = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("SupplierView", "Render", "GET", [], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
