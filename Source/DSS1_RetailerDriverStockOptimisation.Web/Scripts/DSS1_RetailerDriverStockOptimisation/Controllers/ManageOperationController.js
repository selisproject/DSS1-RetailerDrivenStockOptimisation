...
(function (DSS1_RetailerDriverStockOptimisation) {
    ...
    (function (Controllers) {
        ...
        var ManageOperationController = /** @class */ (function () {
            function ManageOperationController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS1_RetailerDriverStockOptimisation.ViewModels.ManageOperation.ManageOperationViewModel._initializeFrom($scope.model, context);
                };
