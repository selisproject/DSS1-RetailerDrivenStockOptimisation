...
interface Window { scope_NotFoundPage: DSS1_RetailerDriverStockOptimisation.Controllers.INotFoundPageScope; }
...
model:
    DSS1_RetailerDriverStockOptimisation.ViewModels.NotFoundPage.NotFoundPageViewModel;
...
class NotFoundPageController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS1_RetailerDriverStockOptimisation.ViewModels.NotFoundPage.NotFoundPageViewModel._lightCast(window.scope_NotFoundPage.model);
    ...
    constructor(private $scope: INotFoundPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS1_RetailerDriverStockOptimisation.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: INotFoundPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS1_RetailerDriverStockOptimisation.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom(window.viewDTO.Model);
