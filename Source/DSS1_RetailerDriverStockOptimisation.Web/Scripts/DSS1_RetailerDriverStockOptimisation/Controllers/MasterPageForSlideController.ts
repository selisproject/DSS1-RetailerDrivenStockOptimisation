...
interface Window { scope_MasterPageForSlide: DSS1_RetailerDriverStockOptimisation.Controllers.IMasterPageForSlideScope; }
...
class MasterPageForSlideController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //
        DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._lightCast(window.scope_MasterPageForSlide.model);
    ...
    constructor(private $scope: IMasterPageForSlideScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._initializeFrom($scope.model, context);
