...
interface Window { scope_ForgotPassword: DSS1_RetailerDriverStockOptimisation.Controllers.IForgotPasswordScope; }
...
model:
    DSS1_RetailerDriverStockOptimisation.ViewModels.ForgotPassword.ForgotPasswordViewModel;
...
private timeoutDelayLockButton11Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS1_RetailerDriverStockOptimisation.ViewModels.ForgotPassword.ForgotPasswordViewModel._lightCast(window.scope_ForgotPassword.model);
    ...
    constructor(private $scope: IForgotPasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS1_RetailerDriverStockOptimisation.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IForgotPasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS1_RetailerDriverStockOptimisation.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom(window.viewDTO.Model);
