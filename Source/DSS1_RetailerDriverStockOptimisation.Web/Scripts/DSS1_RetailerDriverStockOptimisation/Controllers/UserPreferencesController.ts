...
interface Window { scope_UserPreferences: DSS1_RetailerDriverStockOptimisation.Controllers.IUserPreferencesScope; }
...
model:
    DSS1_RetailerDriverStockOptimisation.ViewModels.UserPreferences.UserPreferencesViewModel;
...
private timeoutDelayLockCancelBtnClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS1_RetailerDriverStockOptimisation.ViewModels.UserPreferences.UserPreferencesViewModel._lightCast(window.scope_UserPreferences.model);
    ...
    constructor(private $scope: IUserPreferencesScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS1_RetailerDriverStockOptimisation.ViewModels.UserPreferences.UserPreferencesViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IUserPreferencesScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS1_RetailerDriverStockOptimisation.ViewModels.UserPreferences.UserPreferencesViewModel._initializeFrom(window.viewDTO.Model);
