...
(function (DSS1_RetailerDriverStockOptimisation) {
    ...
    (function (Controllers) {
        ...
        var ErrorPageController = /** @class */ (function () {
            function ErrorPageController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS1_RetailerDriverStockOptimisation.ViewModels.ErrorPage.ErrorPageViewModel._initializeFrom($scope.model, context);
                };
