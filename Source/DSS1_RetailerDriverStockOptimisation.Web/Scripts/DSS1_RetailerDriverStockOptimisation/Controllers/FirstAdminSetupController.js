...
(function (DSS1_RetailerDriverStockOptimisation) {
    ...
    (function (Controllers) {
        ...
        var FirstAdminSetupController = /** @class */ (function () {
            function FirstAdminSetupController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS1_RetailerDriverStockOptimisation.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel._initializeFrom($scope.model, context);
                };
