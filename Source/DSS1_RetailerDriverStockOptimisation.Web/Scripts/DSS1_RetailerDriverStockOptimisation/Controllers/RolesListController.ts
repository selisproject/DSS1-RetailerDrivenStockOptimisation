...
interface Window { scope_RolesList: DSS1_RetailerDriverStockOptimisation.Controllers.IRolesListScope; }
...
model:
    DSS1_RetailerDriverStockOptimisation.ViewModels.RolesList.RolesListViewModel;
...
private timeoutDelayLockIcon3Clicked:
    ...
    constructor(private $scope: IRolesListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS1_RetailerDriverStockOptimisation.ViewModels.RolesList.RolesListViewModel._initializeFrom($scope.model, context);
