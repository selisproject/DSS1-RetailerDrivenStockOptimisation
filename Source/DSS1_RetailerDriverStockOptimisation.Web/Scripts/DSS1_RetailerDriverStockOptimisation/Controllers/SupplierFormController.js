...
(function (DSS1_RetailerDriverStockOptimisation) {
    ...
    (function (Controllers) {
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window._context.currentAction == "AddSupplier"; }, false)];
                    });
                }); },
        ...
        var SupplierFormController = /** @class */ (function () {
            function SupplierFormController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS1_RetailerDriverStockOptimisation.ViewModels.SupplierForm.SupplierFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            SupplierFormController.prototype.init = function ($scope, $timeout) {
                ...
                $scope.actions = {
                    ...
                    EditSupplier: function (id, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                    ...
                    SaveSupplier: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    Joove.Common.autocompleteFix();
                ...
                $scope.eventCallbacks = {
                    cmdSupplierSaveClicked: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockcmdSupplierSaveClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockcmdSupplierSaveClicked);
                        }
                        _this.timeoutDelayLockcmdSupplierSaveClicked = $timeout(function () {
                    ...
                    cmdDeleteSupplierClicked: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockcmdDeleteSupplierClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockcmdDeleteSupplierClicked);
                        }
                        _this.timeoutDelayLockcmdDeleteSupplierClicked = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
