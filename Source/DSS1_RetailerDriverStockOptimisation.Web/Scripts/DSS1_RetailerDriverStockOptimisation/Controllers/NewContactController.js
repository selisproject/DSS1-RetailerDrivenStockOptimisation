...
(function (DSS1_RetailerDriverStockOptimisation) {
    ...
    (function (Controllers) {
        var _this = this;
        var NewContactConditionalFormattings = [
            new Joove.JbRule({
        ...
        var NewContactDataValidations = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, !(Joove.Common.nullSafe(function () { return Joove.Common.isValidEmail(Joove.Common.nullSafe(function () { return window["scope_NewContact"].model.ApplicationUser.Email; }, "")); }, false))];
                    });
                }); },
        ...
        var NewContactCalculatedExpressions = [];
        ...
        var NewContactController = /** @class */ (function () {
            function NewContactController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS1_RetailerDriverStockOptimisation.ViewModels.NewContact.NewContactViewModel._initializeFrom($scope.model, context);
                };
                $scope._validationsMaster = window.scope_MasterPageForSlide._validations;
                $scope._validations = { summary: [],
                    IsMailValid: { rule: NewContactDataValidations[0], group: NewContactDataValidations[0].group },
            ...
            NewContactController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.eventCallbacks = {
                    Button1OnChange: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton1OnChange = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                var p_FormControls_NewContact_FormControlsDefinition_Button1_PickListControl_SelectedItems_ApplicationPermissionViewModel = Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItems($("[jb-id='Button1']"), e); }, null);
                    ...
                    Button2OnChange: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton2OnChange = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                var p_FormControls_NewContact_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationRoleViewModel = Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItems($("[jb-id='Button2']"), e); }, null);
        ...
        angular.module("Application").controller("NewContactController", ["$scope", "$timeout", NewContactController]);
