...
(function (DSS1_RetailerDriverStockOptimisation) {
    ...
    (function (Controllers) {
        ...
        var OperationsListController = /** @class */ (function () {
            function OperationsListController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS1_RetailerDriverStockOptimisation.ViewModels.OperationsList.OperationsListViewModel._initializeFrom($scope.model, context);
                };
