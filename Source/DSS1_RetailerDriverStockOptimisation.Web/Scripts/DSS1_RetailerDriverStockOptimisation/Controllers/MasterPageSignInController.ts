...
interface Window { scope_MasterPageSignIn: DSS1_RetailerDriverStockOptimisation.Controllers.IMasterPageSignInScope; }
...
model:
    DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageSignIn.MasterPageSignInViewModel;
...
class MasterPageSignInController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //
        DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._lightCast(window.scope_MasterPageSignIn.model);
    ...
    constructor(private $scope: IMasterPageSignInScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._initializeFrom($scope.model, context);
