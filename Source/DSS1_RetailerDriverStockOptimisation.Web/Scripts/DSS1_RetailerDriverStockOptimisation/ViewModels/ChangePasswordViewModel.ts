...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.ChangePassword {
export class ChangePasswordViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
