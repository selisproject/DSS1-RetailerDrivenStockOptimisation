...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.ManageOperation {
export class ManageOperationViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
