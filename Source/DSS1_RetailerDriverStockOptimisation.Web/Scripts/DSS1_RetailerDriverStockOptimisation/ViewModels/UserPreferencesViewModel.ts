...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.UserPreferences {
export class UserPreferencesViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
