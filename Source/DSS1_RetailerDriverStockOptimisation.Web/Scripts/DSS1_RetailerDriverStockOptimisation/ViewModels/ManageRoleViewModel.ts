...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.ManageRole {
export class ManageRoleViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
