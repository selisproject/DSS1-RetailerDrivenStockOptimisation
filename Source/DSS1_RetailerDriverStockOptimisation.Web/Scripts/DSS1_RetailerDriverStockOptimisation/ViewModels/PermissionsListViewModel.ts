...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.PermissionsList {
export class PermissionsListViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
