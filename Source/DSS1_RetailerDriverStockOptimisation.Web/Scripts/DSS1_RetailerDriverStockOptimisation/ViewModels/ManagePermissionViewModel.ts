...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.ManagePermission {
export class ManagePermissionViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
