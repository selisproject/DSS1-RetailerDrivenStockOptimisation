...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.ApplicationSettingForm {
export class ApplicationSettingFormViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
