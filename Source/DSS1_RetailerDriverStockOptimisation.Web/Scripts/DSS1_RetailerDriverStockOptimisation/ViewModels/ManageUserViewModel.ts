...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.ManageUser {
export class ManageUserViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
