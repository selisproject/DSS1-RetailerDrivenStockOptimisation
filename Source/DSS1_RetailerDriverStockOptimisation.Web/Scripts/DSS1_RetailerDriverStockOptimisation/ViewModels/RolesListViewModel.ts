...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.RolesList {
export class RolesListViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
