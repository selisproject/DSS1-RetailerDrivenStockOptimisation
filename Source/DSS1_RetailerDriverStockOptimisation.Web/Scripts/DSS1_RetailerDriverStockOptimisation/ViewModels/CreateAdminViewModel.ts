...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.CreateAdmin {
export class CreateAdminViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageSignIn.MasterPageSignInViewModel {
    public constructor() {
        super();
...
var result:
    ...
    public static _deleteDropDownInitialValues(reduced: CreateAdminViewModel) {
        ...
        DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._deleteDropDownInitialValues(reduced);
    }
