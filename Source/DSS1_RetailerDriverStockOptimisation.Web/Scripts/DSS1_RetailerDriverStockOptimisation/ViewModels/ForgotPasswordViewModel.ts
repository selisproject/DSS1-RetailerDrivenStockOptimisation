...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.ForgotPassword {
export class ForgotPasswordViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
