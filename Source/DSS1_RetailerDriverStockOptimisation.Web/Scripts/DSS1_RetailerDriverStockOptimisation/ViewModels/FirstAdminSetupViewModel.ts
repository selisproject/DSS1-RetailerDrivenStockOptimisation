...
namespace DSS1_RetailerDriverStockOptimisation.ViewModels.FirstAdminSetup {
export class FirstAdminSetupViewModel extends DSS1_RetailerDriverStockOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
