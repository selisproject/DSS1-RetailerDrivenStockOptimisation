...
(function (Joove) {
    ...
    (function (Widgets) {
        var ExportHelper = /** @class */ (function () {
            function ExportHelper(listRef) {
                this.listReference = listRef;
            }
            ExportHelper.prototype.getPopUpContent = function () {
            ...
            ExportHelper.prototype.okCallback = function ($container) {
                ...
                var exportAggregatorInfo = this.addAggregatorsForExport($container, visibleColumnsCollection);
                this.export({
                    type: type,
                    range: range,
            ...
            ExportHelper.prototype.getExportPopUpMarkUp = function () {
                return "<div class='export-preferences-container'>             <table class='table' style='margin-bottom:0px;'>                <thead>                    <tr>                        <th style='vertical-align: middle'>" + this.listReference.resources.textResources.ExportType + "</th>                         <th>                             <select class='form-control export-type'>                                <option value='EXCEL'>Excel</option>                                 <option value='WORD'>Word</option>                                 <option value='PDF'>PDF</option>                             </select>                        </th>                    </tr>                    <tr>                        <th style='vertical-align: middle'>" + this.listReference.resources.textResources.ExportRange + "</th>                         <th>                             <select class='form-control export-range'>                                <option value='CURRENT'>" + this.listReference.resources.textResources.ExportRangeCurrent + "</option>                                 <option value='TOP100'>" + this.listReference.resources.textResources.ExportRange100 + "</option>                                 <option value='ALL'>" + this.listReference.resources.textResources.ExportRangeAll + "</option>                             </select>                        </th>                    </tr>                    <tr>                         <th style='vertical-align: middle'>                            <span>" + this.listReference.resources.textResources.FileName + "</span>                        </th>                        <th>                            <input class='default-input form-control export-filename' type='text' value='" + this.listReference.serversideElementId + "'>                         </th>                    </tr>                 </thead>             </table>            <fieldset>            <table class='table' style='width:50%; float:left;'>                    <thead>                         <tr class='row-table-export-pop-up' data-column='export-group-data'>                             <th>                                <span>" + this.listReference.resources.textResources.ExportOnlyGroups + "</span>                            </th>                            <th>                                <input type='checkbox' class='export-only-group-data'>                             </th>                        </tr>                         <tr class='row-table-export-pop-up' data-column='export-PDFportrait-orientation'>                             <th>                                <span>" + this.listReference.resources.textResources.PortraitOrientation + "</span>                            </th>                            <th>                                <input type='checkbox' class='export-portrait-orientation'>                             </th>                        </tr>                         <tr>                            <th>                                <span>" + this.listReference.resources.textResources.IncludeGridLines + "</span>                            </th>                            <th>                                <input type='checkbox' class='export-include-grid-lines'>                             </th>                        </tr>                        <tr class='row-table-export-pop-up' data-column='export-total-count'>                            <th>                                <span>" + this.listReference.resources.textResources.TotalNonGroupCount + "</span>                            </th>                            <th>                                <input type='checkbox' class='export-non-group-count'>                             </th>                        </tr>     \n                        <tr>                            <th colspan='2'>                                <a id='disCols' jb-id='disCols' title='" + this.listReference.resources.textResources.DisplayColumns + "' data-state='collapsed'>                                \n                                    <span>" + this.listReference.resources.textResources.DisplayColumns + "</span>                            \n                                </a>          \n                            </th>\n                        </tr>\n                    </thead>                </table>            <table class='table' style='width:50%'; float:right;>                <thead style='border-left: medium #DDDDDD; border-left-style: solid;'>                     <tr class='row-table-colors-export-pop-up' data-column='row-table-group-color'>                         <th>                            <span>" + this.listReference.resources.textResources.GroupColor + "</span>                        </th>                        <th style='padding:0px 0px 0px 0px; vertical-align:middle;'>                            <button id='group-lines-color' jb-id='group-lines-color' class=\"jscolor {closable:true,closeText:'OK', valueElement:null} color-picker-button\" title='Select color'>                             </button>                         </th>                    </tr>                     <tr class='row-table-colors-export-pop-up' data-column='row-table-header-color'>                         <th>                            <span>" + this.listReference.resources.textResources.HeaderColor + "</span>                        </th>                        <th  style='padding:0px 0px 0px 0px; vertical-align:middle;'>                            <button id='header-line-color' jb-id='header-line-color' class=\"jscolor {closable:true ,closeText:'OK' , valueElement:null, value:'66ccff'} color-picker-button\" title='Select color'>                         </th>                    </tr>                     <tr class='row-table-colors-export-pop-up' data-column='row-table-even-color'>                        <th>                            <span>" + this.listReference.resources.textResources.EvenColor + "</span>                        </th>                        <th  style='padding:0px 0px 0px 0px; vertical-align:middle;'>                            <button id='even-lines-color' jb-id='even-lines-color' class=\"jscolor {closable:true ,closeText:'OK', valueElement:null, value:'DBD7D0'} color-picker-button\" title='Select color'>                         </th>                    </tr>                    <tr class='row-table-colors-export-pop-up' data-column='row-table-odd-color'>                         <th>                            <span>" + this.listReference.resources.textResources.OddColor + "</span>                        </th>                        <th  style='padding:0px 0px 0px 0px; vertical-align:middle;'>                            <button id='odd-lines-color' id='jb-odd-lines-color'  class=\"jscolor {closable:true ,closeText:'OK', valueElement:null, value:'D1BFDB'} color-picker-button\" title='Select color'>                         </th>                    </tr>                     <tr class='row-table-colors-export-pop-up' data-column='row-table-aggregate-color'>                         <th>                            <span>" + this.listReference.resources.textResources.AggregateColor + "</span>                        </th>                        <th  style='padding:0px 0px 0px 0px; vertical-align:middle;'>                            <button id='aggregate-lines-color' jb-id='aggregate-lines-color' class=\"jscolor {closable:true,closeText:'OK', valueElement:null, value:'DBDBDB'} color-picker-button\" title='Select color'>                         </th>                    </tr>                 </thead>             </table>        </fieldset>            \n        </div>";
            };
            ExportHelper.prototype.getExportDisplayColumns = function () {
                return "<div  id='exportDisplayColumns' class= \"hideColumnsPopUp\" jb-id='exportDisplayColumns' style='overflow: hidden; display: none;'>               \n                        <div class='export-table-display-columns'>                             <table class='preferences-table table table-hover'>                             <thead>                                <tr>                                    <th style='width:181px; padding-left: 8px; '>                                        <span class='export-pop-up-subtitle'>" + this.listReference.resources.textResources.ColumnExport + "</span>                                    </th>                                    <th style='width:68px; text-align: center;'>                                        <span class='export-pop-up-subtitle'>" + this.listReference.resources.textResources.VisibleExport + "</span>                                    </th>                                    <th style='width:68px; text-align: center;'>                                        <span class='export-pop-up-subtitle'>" + this.listReference.resources.textResources.SumHeader + "</span>                                    </th>                                    <th style='width:68px; text-align: center;'>                                        <span class='export-pop-up-subtitle'>" + this.listReference.resources.textResources.AverageHeader + "</span>                                    </th>                                    <th style='width:67px; text-align: center;'>                                        <span class='export-pop-up-subtitle'>" + this.listReference.resources.textResources.CountHeader + "</span>                                    </th>                                    <th style='width:18px; text-align: center;'>                                    </th>                                </tr>                                <tr>                                    <th style='vertical-align: top; '>                                    </th>                                    <th style='vertical-align: top; text-align: center;'>                                        <input class='checkall-header-isvisible' type='checkbox' data-state='unchecked'/>                                    </th>                                    <th style='vertical-align: top; text-align: center;'>                                        <input class='checkall-header-issum' type='checkbox' data-state='unchecked'/>                                    </th>                                    <th style='vertical-align: top; text-align: center;'>                                        <input class='checkall-header-isaverage' type='checkbox' data-state='unchecked'/>                                    </th>                                    <th style='vertical-align: top; text-align: center;'>                                        <input class='checkall-header-iscount' type='checkbox' data-state='unchecked'/>                                    </th>                                    <th style='vertical-align: top; text-align: center;'>                                    </th>                                </tr>                            </thead>                            <tbody>                                 " + this.populateExportPopUpTableDisplayContainer() + "                             </tbody>                             </table>                         </div>                     </div>";
            };
            ExportHelper.prototype.populateExportPopUpTableDisplayContainer = function () {
                var str = "";
                for (var i = 0; i < this.listReference.status.columnInfo.length; i++) {
                    ...
                    var line = "<tr class='row-preference' data-column='" + column.name + "'>                            <td style='width:181px; text-align:left;'>                                <span>" + column.caption + "</span>                            </td>                            <td style='width:68px; text-align:center;'>                                <input type='checkbox' class='column-is-visible checkbox-position' checked='checked'/>                            </td>                            <td style='width:68px; text-align:center;'>                                <input type='checkbox' class='sum-is-visible checkbox-position' " + this.listReference.resources.textResources.SumHeader + "/>                            </td>                            <td style='width:68px; text-align:center;'>                                <input type='checkbox' class='average-is-visible checkbox-position' " + this.listReference.resources.textResources.AverageHeader + "/>                            </td>                            <td style='width:67px; text-align:center;'>                                <input type='checkbox' class='count-is-visible checkbox-position' " + this.listReference.resources.textResources.CountHeader + "/>                            </td>                        </tr>";
                    str += line;
                }
                return str;
            };
            ExportHelper.prototype.populateExportPopUpContainer = function ($container, isNotPopUp) {
                var self = this;
                        ...
                        if (allColumns[i].name == null || this.isDataTypeNumeric(allColumns[i]) === false) {
                            ...
                            for (var j = 0; j < this.listReference.status.aggregators.length; j++) {
                                ...
                                if (this.listReference.status.aggregators[j].column == allColumns[i].name &&
                                    this.listReference.status.aggregators[j].type === Joove.AggregatorTypes.SUM) {
                                    $NumericColumn.find(".sum-is-visible").prop("checked", this.listReference.status.aggregators[j].enabled);
                                }
                                if (this.listReference.status.aggregators[j].column == allColumns[i].name &&
                                    this.listReference.status.aggregators[j].type === Joove.AggregatorTypes.AVERAGE) {
                                    $NumericColumn.find(".average-is-visible").prop("checked", this.listReference.status.aggregators[j].enabled);
                                }
                                if (this.listReference.status.aggregators[j].column == allColumns[i].name &&
                                    this.listReference.status.aggregators[j].type === Joove.AggregatorTypes.COUNT) {
                ...
                $container.find(".checkall-header-isvisible").on("click", function () {
                ...
                $container.find(".export-only-group-data").on("change", function () {
                    ...
                    var nonGroupColumns = allColumns.filter(function (x) {
                        for (var i = 0; i < self.listReference.status.groupBy.length; i++) {
                            if (x.name == self.listReference.status.groupBy[i].column.name)
                                return false;
                        }
                        return true;
                    });
            ...
            ExportHelper.prototype.addScrollListener = function ($element) {
            ...
            ExportHelper.prototype.isDataTypeNumeric = function (columnInfo) {
                return Joove.Common.getMambaDataType(columnInfo.mambaDataType) === Joove.MambaDataType.NUMBER;
            };
            ExportHelper.prototype.populateVisibleColumns = function ($container) {
            ...
            ExportHelper.prototype.addAggregatorsForExport = function ($container, visibleColumnsCollection) {
                var exportAggregatorInfo = [];
                var _loop_1 = function (j) {
                    var columnName = visibleColumnsCollection[j].column;
                    var columnInfo = this_1.listReference.status.columnInfo.filter(function (col) { return col.name === columnName; })[0];
                    var exportRowOptions = $container.find(".row-preference[data-column='" + columnName + "']");
                    if (columnInfo == undefined || exportRowOptions.length !== 1) {
                        this_1.listReference.handleError("DATALIST ERROR: Could not find columnInfo or export options for column " + columnName + " during aggregator export");
                        return "continue";
                    }
                    var istSumChecked = exportRowOptions.find(".sum-is-visible").is(":checked") === true;
                    var isAverageChecked = exportRowOptions.find(".average-is-visible").is(":checked") === true;
                    var istCountChecked = exportRowOptions.find(".count-is-visible").is(":checked") === true;
                    if (istSumChecked) {
                        columnName.SumIsVisible = true;
                        exportAggregatorInfo.push(new Widgets.DataListAggregatorInfo(columnInfo.name, Joove.AggregatorTypes.SUM));
                    }
                    if (isAverageChecked) {
                        columnName.AverageIsVisible = true;
                        exportAggregatorInfo.push(new Widgets.DataListAggregatorInfo(columnInfo.name, Joove.AggregatorTypes.AVERAGE));
                    }
                    if (istCountChecked) {
                        columnName.CountIsVisible = true;
                        exportAggregatorInfo.push(new Widgets.DataListAggregatorInfo(columnInfo.name, Joove.AggregatorTypes.COUNT));
                    }
                };
                var this_1 = this;
                for (var j = 0; j < visibleColumnsCollection.length; j++) {
                    _loop_1(j);
                }
                return JSON.stringify(exportAggregatorInfo);
            };
            ExportHelper.prototype.prepareRequestParameters = function (exportOptions) {
            ...
            ExportHelper.prototype.export = function (opts) {
        ...
        Widgets.ExportHelper = ExportHelper;
