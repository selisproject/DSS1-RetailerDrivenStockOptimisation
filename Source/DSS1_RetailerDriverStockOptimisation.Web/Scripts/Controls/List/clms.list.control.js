...
(function (Joove) {
    ...
    (function (Widgets) {
        ...
        */
        ...
        var ListControlAsset = /** @class */ (function () {
        ...
        var ListControl = /** @class */ (function (_super) {
            ...
            */
            ...
            ListControl.prototype.getStateFromLocalStorage = function () {
                try {
                    ...
                    if (this.status.columns
                        ...
                        return null; // different columns number, incompatible
            ...
            ListControl.prototype.getColumnTitleWidth = function (width) {
                var moveIconsWidth = 0; //$listColumnHeader.find(".move-column-right").eq(0).width() * 2;
            ...
            ListControl.prototype.updateSelectedKeysInModel = function (keys) {
                ...
                Joove.DatasourceManager.updateSelectedKeysInModel(controlName, keys, this.status.allRecordsSelected, this.getControlIndexes().indexes); // TODO: there is a 5th parameter for master page...
            };
            ...
            ListControl.prototype.applyPredefinedFilters = function (doNotRefresh) {
                ...
                for (var i = 0; i < predefinedFilterInputs.length; i++) {
                    ...
                    if (seenColumns.indexOf(column) > -1)
                        continue; // normally when encountering 2nd DateTime Field
