...
using DSS1_RetailerDriverStockOptimisation.UI.Controllers.UsersList;
using AppCode;
...
namespace DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList
{
    ...
    [OriginalType(typeof(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList.UsersListViewModel))]
    public class UsersListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList.UsersListViewModel>
    {

        [JsonConstructor]
        public UsersListViewModelDTO() { }
        public UsersListViewModelDTO(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList.UsersListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList.UsersListViewModel).FullName;
        public List<SelectedItemInfo<string>> TableSelectedItemKeys;

        public new DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList.UsersListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList.UsersListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList.UsersListViewModel();
        }
        new  public DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList.UsersListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList.UsersListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.UsersList.UsersListViewModel original)
        {
            if (original == null) return;
