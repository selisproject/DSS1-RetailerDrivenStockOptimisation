...
using DSS1_RetailerDriverStockOptimisation.UI.Controllers.RolesList;
using AppCode;
...
namespace DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList
{
    ...
    [OriginalType(typeof(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList.RolesListViewModel))]
    public class RolesListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList.RolesListViewModel>
    {

        [JsonConstructor]
        public RolesListViewModelDTO() { }
        public RolesListViewModelDTO(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList.RolesListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList.RolesListViewModel).FullName;
        public List<SelectedItemInfo<int?>> TableSelectedItemKeys;

        public new DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList.RolesListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList.RolesListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList.RolesListViewModel();
        }
        new  public DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList.RolesListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList.RolesListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.RolesList.RolesListViewModel original)
        {
            if (original == null) return;
