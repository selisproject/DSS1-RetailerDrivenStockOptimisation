...
using DSS1_RetailerDriverStockOptimisation.UI.Controllers.OperationsList;
using AppCode;
...
namespace DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList
{
    ...
    [OriginalType(typeof(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList.OperationsListViewModel))]
    public class OperationsListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList.OperationsListViewModel>
    {

        [JsonConstructor]
        public OperationsListViewModelDTO() { }
        public OperationsListViewModelDTO(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList.OperationsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList.OperationsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> TableSelectedItemKeys;

        public new DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList.OperationsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList.OperationsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList.OperationsListViewModel();
        }
        new  public DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList.OperationsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList.OperationsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS1_RetailerDriverStockOptimisation.UI.ViewModels.OperationsList.OperationsListViewModel original)
        {
            if (original == null) return;
