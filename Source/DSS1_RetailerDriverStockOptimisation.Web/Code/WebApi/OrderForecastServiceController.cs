...
namespace DSS1_RetailerDriverStockOptimisation.Web.Code.WebApi
{
    ...
    public class OrderForecastServiceController : BasicApiCtrl
    {
        ...
        [Route("calculate")]
        [HttpGet]
        public System.Collections.Generic.List<DSS1_RetailerDriverStockOptimisation.Services.OrderForecastService.DataContracts.OrderForecastDetailsDTO> CalculateForSKU(string sku = "")
        {
            ...
            var result =  (new DSS1_RetailerDriverStockOptimisation.Services.OrderForecastServiceService()).CalculateForSKU(sku,_RequestSourceIp, _UserName);
            return result;
        }
    }
}
