...
using DSS1_RetailerDriverStockOptimisation.UI.ViewModels.ApplicationSettingForm;
...
namespace DSS1_RetailerDriverStockOptimisation.UI.Controllers.ApplicationSettingForm
{
    ...
    public class ApplicationSettingFormController : ControllerBase<ApplicationSettingFormViewModel, ApplicationSettingFormViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditApplicationSetting(int? Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationSetting =  new DSS1_RetailerDriverStockOptimisation.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>(Id);
        ...
        {
            ActionResult _result = null;
            new DSS1_RetailerDriverStockOptimisation.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>(@model.ApplicationSetting);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DSS1_RetailerDriverStockOptimisation.DAL.Repository().DeleteApplicationSetting(@model.ApplicationSetting);
            _result = CloseForm();
            return _result;
        }
        #endregion
