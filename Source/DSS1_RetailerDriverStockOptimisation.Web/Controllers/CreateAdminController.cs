...
using DSS1_RetailerDriverStockOptimisation.UI.ViewModels.CreateAdmin;
...
namespace DSS1_RetailerDriverStockOptimisation.UI.Controllers.CreateAdmin
{
    ...
    public class CreateAdminController : ControllerBase<CreateAdminViewModel, CreateAdminViewModelDTO>
    {
        ...
        {
            var masterViewModel = new DSS1_RetailerDriverStockOptimisation.UI.ViewModels.MasterPageSignIn.MasterPageSignInViewModel
            {
...

        {
            ...
            System.Web.HttpContext.Current.Session["LastEntryPoint_CreateAdmin"] = "Index";
            PushToHistory();
            var _masterController = new DSS1_RetailerDriverStockOptimisation.UI.Controllers.MasterPageSignIn.MasterPageSignInController(@model);
        ...
        {
            if (_parentController == null) _parentController = new MasterPageSignIn.MasterPageSignInController(new  DSS1_RetailerDriverStockOptimisation.UI.ViewModels.MasterPageSignIn.MasterPageSignInViewModel());
        ...
        {
            ActionResult _result = null;
            if ((new DSS1_RetailerDriverStockOptimisation.DAL.Repository().GetCount<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>((u) => u.Roles.Any((r) => r.Name == "Administrator")) > 0))
            {
