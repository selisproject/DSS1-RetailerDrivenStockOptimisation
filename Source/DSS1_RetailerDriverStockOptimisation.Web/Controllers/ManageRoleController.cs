...
using DSS1_RetailerDriverStockOptimisation.UI.ViewModels.ManageRole;
...
namespace DSS1_RetailerDriverStockOptimisation.UI.Controllers.ManageRole
{
    ...
    public class ManageRoleController : ControllerBase<ManageRoleViewModel, ManageRoleViewModelDTO>
    {
        ...
        {
            ActionResult _result = null;
            new DSS1_RetailerDriverStockOptimisation.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>(@model.ApplicationRole);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DSS1_RetailerDriverStockOptimisation.DAL.Repository().DeleteApplicationRole(@model.ApplicationRole);
            _result = CloseForm();
            return _result;
        }
