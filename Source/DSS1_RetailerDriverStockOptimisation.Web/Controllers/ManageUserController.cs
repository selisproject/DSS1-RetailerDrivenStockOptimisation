...
using DSS1_RetailerDriverStockOptimisation.UI.ViewModels.ManageUser;
...
namespace DSS1_RetailerDriverStockOptimisation.UI.Controllers.ManageUser
{
    ...
    public class ManageUserController : ControllerBase<ManageUserViewModel, ManageUserViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditUser(string Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationUser =  new DSS1_RetailerDriverStockOptimisation.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>(Id);
        ...
        {
            ActionResult _result = null;
            new DSS1_RetailerDriverStockOptimisation.DAL.Repository().DeleteApplicationUser(@model.ApplicationUser);
            _result = CloseForm();
            return _result;
        }
