...
using DSS1_RetailerDriverStockOptimisation.UI.ViewModels.ErrorPage;
...
namespace DSS1_RetailerDriverStockOptimisation.UI.Controllers.ErrorPage
{
    ...
    public class ErrorPageController : ControllerBase<ErrorPageViewModel, ErrorPageViewModelDTO>
    {
        ...
        public ActionResult ExecuteRender()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("ErrorPage", "RES_PAGETITLE_Render").ToString();
        ...
        public ActionResult ExecuteSendErrorToAdministrator()
        {
            ...
            mail.Subject = "DSS1_RetailerDriverStockOptimisation" + " threw an Exception";
