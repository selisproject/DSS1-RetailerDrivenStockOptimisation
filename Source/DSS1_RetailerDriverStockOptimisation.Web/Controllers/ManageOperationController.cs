...
using DSS1_RetailerDriverStockOptimisation.UI.ViewModels.ManageOperation;
...
namespace DSS1_RetailerDriverStockOptimisation.UI.Controllers.ManageOperation
{
    ...
    public class ManageOperationController : ControllerBase<ManageOperationViewModel, ManageOperationViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditOperation(int? Id)
        {
            ...
            @model.ApplicationOperation =  new DSS1_RetailerDriverStockOptimisation.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>(Id);
        ...
        {
            ActionResult _result = null;
            new DSS1_RetailerDriverStockOptimisation.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>(@model.ApplicationOperation);
            _result = CloseForm();
            return _result;
        }
