...
using DSS1_RetailerDriverStockOptimisation.UI.ViewModels.AdminDashboard;
...
namespace DSS1_RetailerDriverStockOptimisation.UI.Controllers.AdminDashboard
{

    [RoutePrefix("AdminDashboard")]
    public class AdminDashboardController : ControllerBase<AdminDashboardViewModel, AdminDashboardViewModelDTO>
    {

        /*<Form:AdminDashboard:0/>*/
        public AdminDashboardController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(AdminDashboardController));
        ...
        public void SetModel(AdminDashboardViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(AdminDashboardViewModel));
        }
...

        {
            ...
            System.Web.HttpContext.Current.Session["LastEntryPoint_AdminDashboard"] = "Render";
            return null;
        }
        ...
        public ActionResult ExecuteRender()
        {
            ...
            @model.Title = "";
            @model.Agreements = new DSS1_RetailerDriverStockOptimisation.DAL.Repository().GetAll<DSS1_RetailerDriverStockOptimisation.BO.Agreement>().ToList();
            @model.OrderForecasts = new DSS1_RetailerDriverStockOptimisation.DAL.Repository().GetAsQueryable<DSS1_RetailerDriverStockOptimisation.BO.OrderForecastDetails>()?.OrderByDescending((a) => a.Quantity).Take(7).ToList().ToList();
            return _result;
        }
        #endregion
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new AdminDashboardViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: AdminDashboard, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
