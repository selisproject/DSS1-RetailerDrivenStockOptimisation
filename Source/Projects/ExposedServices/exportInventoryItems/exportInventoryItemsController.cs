...
namespace DSS1_RetailerDriverStockOptimisation.Web.Code.WebApi
{
    ...
    public class exportInventoryItemsController : BasicApiCtrl
    {
        ...
        [Route("Export")]
        [HttpGet]
        public System.Collections.Generic.List<DSS1_RetailerDriverStockOptimisation.Services.exportInventoryItems.DataContracts.InventoryItemDTO> Export()
        {
            ...
            var result =  (new DSS1_RetailerDriverStockOptimisation.Services.exportInventoryItemsService()).Export(_RequestSourceIp, _UserName);
            return result;
        }
    }
}
