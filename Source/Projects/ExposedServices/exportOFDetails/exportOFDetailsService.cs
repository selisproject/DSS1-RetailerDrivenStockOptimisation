...
using DSS1_RetailerDriverStockOptimisation.Services.exportOFDetails.DataContracts;
    ...
    public class exportOFDetailsService : IexportOFDetailsService
    {
        public System.Collections.Generic.List<OrderForecastDetailsDTO> ExportOFDetails(string _RequestSourceIp, string _UserName)
        {
            ...
            try
            {
                ...
                var result = Mapper.Map<System.Collections.Generic.List<DSS1_RetailerDriverStockOptimisation.BO.OrderForecastDetails>, System.Collections.Generic.List<OrderForecastDetailsDTO>>(_exportOFDetails);
                return result;
            }
        ...
        public static System.Collections.Generic.List<DSS1_RetailerDriverStockOptimisation.BO.OrderForecastDetails> ExportOFDetailsImplementation()
        {
            return new DSS1_RetailerDriverStockOptimisation.DAL.Repository().GetAsQueryable<DSS1_RetailerDriverStockOptimisation.BO.OrderForecastDetails>()?.Take(500).ToList();
        }
