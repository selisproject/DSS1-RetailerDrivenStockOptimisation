...
namespace DSS1_RetailerDriverStockOptimisation.BoTesting.Tests
{
    ...
    internal class SupplierParameterTests : NHibernateFixture
    {
        ...
        public void SupplierParameter_filtering_test()
        {
            ...
            List<DSS1_RetailerDriverStockOptimisation.BO.SupplierParameter> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS1_RetailerDriverStockOptimisation.BO.SupplierParameter>(
                              a => true
