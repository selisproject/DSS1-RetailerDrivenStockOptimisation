...
namespace DSS1_RetailerDriverStockOptimisation.BoTesting.Tests
{
    ...
    internal class AgreementStatusTests : NHibernateFixture
    {
        ...
        public void AgreementStatus_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS1_RetailerDriverStockOptimisation.BO.AgreementStatus>(Session)
        ...
        public void AgreementStatus_filtering_test()
        {
            ...
            List<DSS1_RetailerDriverStockOptimisation.BO.AgreementStatus> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS1_RetailerDriverStockOptimisation.BO.AgreementStatus>(
                              a => true
