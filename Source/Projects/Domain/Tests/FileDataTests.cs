...
namespace DSS1_RetailerDriverStockOptimisation.BoTesting.Tests
{
    ...
    internal class FileDataTests : NHibernateFixture
    {
        ...
        public void FileData_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS1_RetailerDriverStockOptimisation.BO.FileData>(Session)
            .CheckProperty(p => p.FileName, "FileData_FileName")
            .CheckProperty(p => p.FolderPath, "FileData_FolderPath")
            .CheckProperty(p => p.MaxFileSize, 1189)
        ...
        public void FileData_filtering_test()
        {
            ...
            List<DSS1_RetailerDriverStockOptimisation.BO.FileData> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS1_RetailerDriverStockOptimisation.BO.FileData>(
                              a => true
                              ...
                              && a.Blob != null
                              && a.StorageMedium == DSS1_RetailerDriverStockOptimisation.BO.StorageMedium.FileSystem
