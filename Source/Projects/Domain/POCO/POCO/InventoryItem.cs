...
namespace DSS1_RetailerDriverStockOptimisation.BO
{
    ...
    [Serializable]
    [DataContract]
    public class InventoryItem : IDomainModelClass
    {
        #region InventoryItem's Fields
        ...
        #endregion
        #region InventoryItem's Properties
/// <summary>
/// The Id property
///
/// </summary>
...
///
        ...
        #endregion
        #region InventoryItem's Participant Properties
        ...
        public virtual Item Item
        {
            ...
            set
            {
                ...
                var __oldValue = item;
                item?.InternalRemoveInventoryItems(this);
                item = value;
                if (value != null)
                {
                    item.InternalAddInventoryItems(this);
                }
            }
        }
        ...
        #region Constructors
/// <summary>
/// Public constructors of the InventoryItem class
/// </summary>
/// <returns>New InventoryItem object</returns>
/// <remarks></remarks>
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            {
                throw new zAppDev.DotNet.Framework.Exceptions.BusinessException("An instance of TypeClass 'InventoryItem' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
        ...
        public virtual int _GetUniqueIdentifier()
        {
            ...
            hashCode = hashCode * -1521134295 + (SafetyStock?.GetHashCode() ?? 0);
...
/// <param name="copy">Optional - An existing [InventoryItem] instance to use as the destination.</param>
/// <returns>A copy of the object</returns>
        public virtual InventoryItem Copy(bool deep=false, Hashtable copiedObjects=null, bool asNew=false, bool reuseNestedObjects = false, InventoryItem copy = null)
        {
            ...
            if (copy == null && copiedObjects.Contains(this))
                return (InventoryItem)copiedObjects[this];
            copy = copy ?? new InventoryItem();
            if (!asNew)
            {
            ...
            copy.SafetyStock = this.SafetyStock;
        ...
        {
            var compareTo = obj as InventoryItem;
...
// Maintain equality operator semantics for entities.
        public static bool operator ==(InventoryItem x, InventoryItem y)
        {
...
/// </summary>
        protected bool HasSameNonDefaultIdAs(InventoryItem compareTo)
        {
