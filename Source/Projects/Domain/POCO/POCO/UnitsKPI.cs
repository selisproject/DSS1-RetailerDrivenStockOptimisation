...
namespace DSS1_RetailerDriverStockOptimisation.BO
{
    ...
    [Serializable]
    [DataContract]
    public class UnitsKPI : IDomainModelClass
    {
        #region UnitsKPI's Fields
...
///
        ...
        #region Constructors
/// <summary>
/// Public constructors of the UnitsKPI class
/// </summary>
/// <returns>New UnitsKPI object</returns>
/// <remarks></remarks>
        public UnitsKPI() {}
        #endregion
        #region Methods
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            {
                throw new zAppDev.DotNet.Framework.Exceptions.BusinessException("An instance of TypeClass 'UnitsKPI' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
...
/// <param name="copy">Optional - An existing [UnitsKPI] instance to use as the destination.</param>
/// <returns>A copy of the object</returns>
        public virtual UnitsKPI Copy(bool deep=false, Hashtable copiedObjects=null, bool asNew=false, bool reuseNestedObjects = false, UnitsKPI copy = null)
        {
            ...
            if (copy == null && copiedObjects.Contains(this))
                return (UnitsKPI)copiedObjects[this];
            copy = copy ?? new UnitsKPI();
            if (!asNew)
            {
...
// Maintain equality operator semantics for entities.
        public static bool operator ==(UnitsKPI x, UnitsKPI y)
        {
...
/// </summary>
        protected bool HasSameNonDefaultIdAs(UnitsKPI compareTo)
        {
