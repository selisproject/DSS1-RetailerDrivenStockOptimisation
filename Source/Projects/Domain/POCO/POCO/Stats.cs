...
namespace DSS1_RetailerDriverStockOptimisation.BO
{
    ...
    [Serializable]
    [DataContract]
    public class Stats : IDomainModelClass
    {
        #region Stats's Fields
...
///
        ...
        #endregion
        #region Stats's Participant Properties
        ...
        #region Constructors
/// <summary>
/// Public constructors of the Stats class
/// </summary>
/// <returns>New Stats object</returns>
/// <remarks></remarks>
        public Stats() {}
        #endregion
        #region Methods
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            {
                throw new zAppDev.DotNet.Framework.Exceptions.BusinessException("An instance of TypeClass 'Stats' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
...
/// <param name="copy">Optional - An existing [Stats] instance to use as the destination.</param>
/// <returns>A copy of the object</returns>
        public virtual Stats Copy(bool deep=false, Hashtable copiedObjects=null, bool asNew=false, bool reuseNestedObjects = false, Stats copy = null)
        {
            ...
            if (copy == null && copiedObjects.Contains(this))
                return (Stats)copiedObjects[this];
            copy = copy ?? new Stats();
            if (!asNew)
            {
...
/// </summary>
        protected bool HasSameNonDefaultIdAs(Stats compareTo)
        {
