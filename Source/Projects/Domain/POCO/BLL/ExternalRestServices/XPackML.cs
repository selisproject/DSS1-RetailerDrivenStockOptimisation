...
namespace DSS1_RetailerDriverStockOptimisation.BLL.ExternalRestServices
{
    public class XPackMLRestService
    {
        ...
        public static DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.Results GetAnomaliesOnMaxElapseTime(int? hits, DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.RecordRequest q)
        {
