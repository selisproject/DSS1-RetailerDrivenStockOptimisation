...
namespace DSS1_RetailerDriverStockOptimisation.BO
{
	...
	{
        public static void CreateNotifications(DSS1_RetailerDriverStockOptimisation.BO.OrderForecast orderForecast){using (new zAppDev.DotNet.Framework.Profiling.Profiler("Notification", zAppDev.DotNet.Framework.Profiling.AppDevSymbolType.ClassOperation, "CreateNotifications")) {
...
public static System.Collections.Generic.List<DSS1_RetailerDriverStockOptimisation.BO.Notification> GetNotifications(string sku, int? supplierId, int? businessUnitId, int? warehouseId, int? categoryId, int? subCategoryId, int? baseUnitId, DateTime? fromDate, DateTime? toDate){using (new zAppDev.DotNet.Framework.Profiling.Profiler("Notification", zAppDev.DotNet.Framework.Profiling.AppDevSymbolType.ClassOperation, "GetNotifications")) {
zAppDev.DotNet.Framework.Utilities.DebugHelper.Log(zAppDev.DotNet.Framework.Utilities.DebugMessageType.Info, "Notification",  DSS1_RetailerDriverStockOptimisation.Hubs.EventsHub.RaiseDebugMessage, "WH: " + warehouseId.GetValueOrDefault(0));
zAppDev.DotNet.Framework.Utilities.DebugHelper.Log(zAppDev.DotNet.Framework.Utilities.DebugMessageType.Info, "Notification",  DSS1_RetailerDriverStockOptimisation.Hubs.EventsHub.RaiseDebugMessage, "Getting Notifications...");
var _var2 = fromDate?.Date;var _var3 = (fromDate?.Date ?? System.Data.SqlTypes.SqlDateTime.MinValue.Value);var _var4 = toDate?.Date;var _var5 = (toDate?.Date ?? System.Data.SqlTypes.SqlDateTime.MinValue.Value);return new DSS1_RetailerDriverStockOptimisation.DAL.Repository().Get<DSS1_RetailerDriverStockOptimisation.BO.Notification>((a) => ((sku == null || sku.Trim() == "") || a.Item.SKU == sku) && (warehouseId == 0 || a.Warehouse.Id == warehouseId) && (supplierId == 0 || a.Item.Supplier.Id == supplierId) && (businessUnitId == 0 || a.Item.BusinessUnit.Id == businessUnitId) && (categoryId == 0 || a.Item.Category.Id == categoryId) && (subCategoryId == 0 || a.Item.SubCategory.Id == subCategoryId) && (baseUnitId == 0 || a.Item.BaseUnit.Id == baseUnitId) && (_var2 == null || a.SalesForecastDate.GetValueOrDefault(System.Data.SqlTypes.SqlDateTime.MinValue.Value).Date >= _var3) && (_var4 == null || a.SalesForecastDate.GetValueOrDefault(System.Data.SqlTypes.SqlDateTime.MinValue.Value).Date <= _var5));
}
}
