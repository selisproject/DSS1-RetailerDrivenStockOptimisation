...
namespace DSS1_RetailerDriverStockOptimisation.Locales
{
    ...
    public class LocaleResolver
    {
        ...
        private static string ReadEmbededResource(string fullPath)
        {
            ...
            var stream = typeof(DSS1_RetailerDriverStockOptimisation.Locales.LocaleResolver).Assembly.GetManifestResourceStream(fullPath);
            if (stream == null)
            {
                stream = typeof(DSS1_RetailerDriverStockOptimisation.Locales.LocaleResolver).Assembly.GetManifestResourceStream("Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DSS1_RetailerDriverStockOptimisation.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DSS1_RetailerDriverStockOptimisation."+ "Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DSS1_RetailerDriverStockOptimisation.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DSS1_RetailerDriverStockOptimisation."+ "Locales.Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DSS1_RetailerDriverStockOptimisation.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DSS1_RetailerDriverStockOptimisation.Backend."+ "Locales.Locales." + fullPath);
            }
