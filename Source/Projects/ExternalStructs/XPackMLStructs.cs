...
namespace DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML
{
    ...
    public class RecordRequest
    {
        ...
        public DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.QueryOperation query
        {
            get;
            set;
        }
    ...
    public class QueryOperation
    {
        ...
        public DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.BoolOperation Bool
        {
            get;
            set;
        }
    ...
    public class BoolOperation
    {
        ...
        public DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.MustOperation must
        {
            get;
            set;
        }
        ...
        public DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.Filter filter
        {
            get;
            set;
        }
    ...
    public class MustOperation
    {
        ...
        public DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.QueryString query_string
        {
            get;
            set;
        }
    ...
    public class Filter
    {
        ...
        public DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.Range range
        {
            get;
            set;
        }
    ...
    public class Range
    {
        ...
        public DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.Timestamp timestamp
        {
            get;
            set;
        }
    ...
    public class Results
    {
        ...
        public DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.HitsContainer hits
        {
            get;
            set;
        }
    ...
    public class XPackMLRoot
    {
        ...
        public DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.source source
        {
            get;
            set;
        }
    ...
    public class HitsContainer
    {
        ...
        [XmlElement("hits")]
        [Newtonsoft.Json.JsonProperty("hits")]
        public System.Collections.Generic.List<DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.XPackMLRoot> hits
        {
            get;
            set;
        }
    ...
    public class source
    {
        ...
        public DSS1_RetailerDriverStockOptimisation.ExternalStructs.XPackML.influencers[] influencers
        {
            get;
            set;
        }
